<template>
    <div>
        <!-- Title Page -->
        <section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(https://picsum.photos/1920/329/?image=526);">
                    ...
                    <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                        ...
                        <div class="pagination flex-m flex-w p-t-26">
                            <template v-for="p in Math.ceil(totalProducts/12)">
                                <button type="button" @click="changePage(p-1)" class="item-pagination flex-c-m trans-0-4" :class="{'active-pagination':p-1 === page}">
                                    {{p}}
                                </button>
                            </template>                            
                        </div>
