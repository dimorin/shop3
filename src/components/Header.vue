        ...
        <div class="wrap-side-menu" >
            <nav class="side-menu">
                <ul class="main-menu">
                    ...
                    <router-link :to="{name:'home'}" tag="li" class="item-menu-mobile"><a>Home</a></router-link>
                    <router-link :to="{name:'shop'}" tag="li" class="item-menu-mobile"><a>Shop</a></router-link>
                    <router-link :to="{name:'features'}" tag="li" class="item-menu-mobile"><a>Features</a></router-link>
                    <!--
